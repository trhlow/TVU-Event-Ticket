    ...
    <div className="mx-auto max-w-3xl space-y-6 text-left">
      <div className="enterprise-card card-hover-lift space-y-6 p-6 md:p-8">
        <div className="space-y-3">
          ...
          <h2 className="font-display text-2xl font-black tracking-tight text-gray-950 md:text-3xl">{title}</h2>
        ...
        <div className="flex flex-col gap-3 pt-2 sm:flex-row">
          <Link
            to={backTo}
            className="btn-press inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-brand-600 px-4 py-2.5 text-sm font-extrabold text-white shadow-sm shadow-brand-700/20 transition-colors hover:bg-brand-700"
          >
            {backLabel}
