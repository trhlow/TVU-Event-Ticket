      ...
      <section className="page-hero p-6 text-white md:p-8">
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-4 font-display text-4xl font-extrabold tracking-tight md:text-5xl">Hồ sơ tài khoản</h1>
          ...
          <div className="rounded-2xl border border-white/20 bg-white/12 px-5 py-4 backdrop-blur">
            ...
            <p className="mt-1 text-lg font-black text-white">Đang hoạt động</p>
          </div>
        </div>
      </section>
      ...
      >
        <section className="enterprise-card p-6">
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-2">
            ...
            <label className="space-y-1.5">
              <span className="text-xs font-extrabold uppercase tracking-wider text-slate-500">Email</span>
              <span className="relative block">
            ...
            <label className="space-y-1.5">
              <span className="text-xs font-extrabold uppercase tracking-wider text-slate-500">Chức danh</span>
            ...
            <label className="space-y-1.5">
              <span className="text-xs font-extrabold uppercase tracking-wider text-slate-500">Số điện thoại liên hệ</span>
          ...
          <div className="mt-6 flex justify-end border-t border-slate-100 pt-4">
            <button className="btn-press inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-brand-700 px-5 text-sm font-extrabold text-white hover:bg-brand-800">
        ...
        <aside className="enterprise-card h-fit p-5">
          ...
          <h2 className="mt-4 font-display text-lg font-extrabold text-slate-950">{isAdmin ? "Phạm vi quản trị" : "Câu lạc bộ phụ trách"}</h2>
          ...
          <div className="mt-4 rounded-2xl border border-slate-100 bg-slate-50 p-4">
            <p className="text-xs font-extrabold uppercase tracking-wider text-slate-400">Bảo mật</p>
