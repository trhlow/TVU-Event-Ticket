    ...
    <div className="space-y-6 text-left">
      ...
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div className="space-y-1">
          <h2 className="text-xl font-black tracking-tight text-gray-950">Quản lý tài khoản Ban tổ chức</h2>
          <p className="text-xs font-semibold text-gray-500">Chỉ tạo tài khoản khi backend hỗ trợ mật khẩu tạm thời hoặc link thiết lập mật khẩu.</p>
        </div>
