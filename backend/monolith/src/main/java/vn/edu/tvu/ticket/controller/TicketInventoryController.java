...
@Tag(name = "Ticket inventory", description = "Event ticket counter snapshots owned by the ticketing feature")
public class TicketInventoryController {
    ...
    @Operation(summary = "Initialize ticket inventory for an event")
